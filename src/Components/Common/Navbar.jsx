    ...
    return (
        <nav className='max-w-screen mx-auto px-4 sm:px-6 md:px-8 bg-black/85'>
            <div className='text-white text-xs md:text-sm flex items-center justify-between'>
                <div className='relative bg-yellow-400/95 text-black hover:text-white transition-all duration-300 md:py-3 md:px-4 py-1 px-2  flex items-center gap-2 cursor-pointer'>
                ...
                <div className='bg-yellow-400/95 text-black hover:text-white transition-all duration-300 md:py-3 md:px-4 py-1 px-2  flex items-center gap-2 cursor-pointer'>
