    ...
    return (
        <nav className='max-w-screen mx-auto px-4 sm:px-6 md:px-8 bg-black/85'>
            <div className='text-white text-xs md:text-sm flex items-center justify-between'>
                <div onClick={toggleMenu} className='relative bg-blue-500 text-white hover:bg-blue-700 transition-all duration-300 md:py-3 md:px-4 py-1 px-2  flex items-center gap-2 cursor-pointer'>
                ...
                <div className='hidden lg:flex gap-6'>
                    <Link to="/collections/all" className='nav-link'>Computers & Laptops</Link>
                ...
                <div className='bg-blue-500 text-white hover:bg-blue-700 transition-all duration-300 md:py-3 md:px-4 py-1 px-2  flex items-center gap-2 cursor-pointer'>
