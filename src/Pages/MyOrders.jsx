                ...
                <table className='table-auto w-full'>
                    <thead>
                        <tr className='bg-blue-500 text-white'>
                            ...
                            <th className="py2 px-4 sm:py-3 text-sm text-start">Order ID</th>
                            <th className="py2 px-4 sm:py-3 text-sm text-start">Created</th>
                            <th className="py2 px-4 sm:py-3 text-sm text-start">Shipping Address</th>
                            <th className="py2 px-4 sm:py-3 text-sm text-start">Quantity</th>
                            <th className="py2 px-4 sm:py-3 text-sm text-start">Price</th>
                            <th className="py2 px-4 sm:py-3 text-sm text-start">Status</th>
                        </tr>
                    </thead>
                            ...
                            orders.map((order) => (
                                ...
                                >
                                    <td className='py-2 px-4 sm:py-3 text-sm flex items-center justify-center'>
                                        <img src={order.orderItems[0].image} alt={order.orderItems[0].image} className='w-16 h-14 rounded-md' />
                                    </td>
